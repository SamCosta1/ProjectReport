...
\fig{figures/sourcetree_issue.png}{An example of Source Tree passing errors on to the user.}{fig:sourcetree_issue}{0.2}
...
Figure \ref{fig:highlevel} shows an overview of the system. The three main components shown run on distinct machines communicating over the internet. The GUI is the graphical user interface that runs on the user's machine, allowing them to manipulate their repositories. 
